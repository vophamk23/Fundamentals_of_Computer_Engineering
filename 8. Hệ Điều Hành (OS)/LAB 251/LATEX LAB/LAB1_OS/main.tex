...
\usepackage[table]{xcolor} % cho tô màu
\usepackage{array} % điều chỉnh cột
...
\tcbset{
    myterminal/.style={
        colback=black!5, % màu nền
        colframe=black,  % màu viền
        boxrule=0.5pt,   % độ dày viền
        arc=2mm,         % bo góc
        left=2mm, right=2mm, top=1mm, bottom=1mm,
        fontupper=\ttfamily, % font kiểu máy đánh chữ
    }
}
...
\begin{center}
    ...
    \textbf{\large THỰC HÀNH 1} \\ 
    \vspace{0.1cm}
    \textbf{\Large GIỚI THIỆU TỔNG QUAN VỀ LẬP TRÌNH TRÊN HỆ ĐIỀU HÀNH LINUX} 
...
\vspace{3cm}
\begin{center}
{\footnotesize \hspace{1cm} \large Thành Phố Hồ Chí Minh, Tháng 10/2025}
\end{center}
\end{titlepage}
