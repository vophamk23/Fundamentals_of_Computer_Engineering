...
\usepackage[table]{xcolor} % thêm vào phần preamble
\usepackage{array}

% Định nghĩa màu
\definecolor{headercolor}{RGB}{100,149,237}  % màu xanh nhẹ cho header
\definecolor{rowcolor}{RGB}{220,230,250}     % màu nền cho các hàng
\usepackage{hyperref}
\usepackage{booktabs}
\usepackage{alltt}
...
\begin{center}
    ...
    \textbf{\Large THỰC HÀNH 3} \\ 
    \vspace{0.5cm}
    \textbf{\fontsize{25}{12}\selectfont\bfseries \textcolor{red} {SYNCHRONIZATION}} 
...
\vspace{3cm}
\begin{center}
{\footnotesize \hspace{1cm} \large Ho Chi Minh, Tháng 11/2025}
\end{center}
\end{titlepage}
